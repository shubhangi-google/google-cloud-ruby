...
describe "Files Snippets" do
  ...
  describe "set_object_contexts" do
    ...
    it "list_object_contexts" do
      bucket.create_file local_file, remote_file_name
      custom_context_key1 = "my-custom-key"
      custom_context_value1 = "my-custom-value"
      custom_context_key2 = "my-custom-key-2"
      custom_context_value2 = "my-custom-value-2"
      ...
      assert_output "Contexts for #{remote_file_name} has been updated.\n" do
        list_object_contexts bucket_name: bucket.name, file_name: remote_file_name, custom_context_key: custom_context_key1, custom_context_value: custom_context_value1
      end
    end
  end
